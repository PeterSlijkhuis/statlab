...
<Interpret
  id="i-7-2"
  question="A colleague asks you to explain, in your report, what the confidence interval means. Which sentence goes in?"
  choices={[
    { text: 'Mean exam score was 73.9, 95% CI [70.5, 77.3]. Intervals constructed this way contain the population mean in 95% of repeated samples.', correct: true, response: 'Correct, and this is the form a careful reader is looking for: the coverage is attributed to the construction, across repeated samples.' },
