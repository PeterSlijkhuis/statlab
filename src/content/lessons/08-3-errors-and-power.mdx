...
nothing. Had one of them been your own analysis, you would have concluded there was no
...
<Interpret
  id="i-8-3"
  question="Your study of 20 students per group found a 5.7-point difference, t(38) = 1.31, p = .198, 95% CI [-3.1, 14.5], and a power analysis puts the design at about 30% power for an effect this size. What goes in the report?"
  choices={[
